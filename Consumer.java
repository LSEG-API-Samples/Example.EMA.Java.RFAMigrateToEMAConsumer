...
public class Consumer 
{
	public static void main(String[] args)
	{
		...
		try
		{
			...
			long directoryHandle = consumer.registerClient(reqMsg.domainType(EmaRdm.MMT_DIRECTORY).serviceName("API_ELEKTRON_EPD_RSSL"), appClient);

			long handle = consumer.registerClient(reqMsg.clear().serviceName("API_ELEKTRON_EPD_RSSL").name("TRI.N"), appClient);
